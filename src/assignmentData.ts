...
export const assignmentAnswers: AssignmentAnswer[] = [
  ...
  },
  {
    ...
    rationale: 'Das Sie schafft für mich eine klare professionelle Rolle. Bei einem langjährigen Kunden aus der Sportwagenbranche wurde daraus irgendwann ein Du; danach wurden Abstimmungen privater, Feedback persönlicher und Wochenendanrufe häufiger. Nicht das Du war das Problem, sondern Nähe ohne klare Grenzen. Deshalb beginne ich mit dem Sie und lasse Vertrauen durch die Zusammenarbeit entstehen.',
  ...
  },
  {
    ...
    price: 'Leistungseinbrüche und Ausfälle lassen sich in dieser Größe weniger leicht auffangen; auch Spezialisierungsmöglichkeiten können begrenzter sein. Wirtschaftliches Wachstum stößt früher an Grenzen als in einer größeren Organisation.',
  },
]
